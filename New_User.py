...
class Ui_NewUserWidget(object):
    def setupUi(self, NewUserWidget):
        ...
        self.confirm_new_user_btnbx = QDialogButtonBox(NewUserWidget)
        self.confirm_new_user_btnbx.setObjectName(u"confirm_new_user_btnbx")
        self.confirm_new_user_btnbx.setGeometry(QRect(200, 660, 151, 31))
        self.confirm_new_user_btnbx.setStandardButtons(QDialogButtonBox.Cancel|QDialogButtonBox.Ok)
        self.confirm_new_user_btnbx.setCenterButtons(False)
        ...
        self.confirm_new_user_btnbx.raise_()
