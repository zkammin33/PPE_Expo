...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.select_date_label.setGeometry(QRect(20, 10, 171, 16))
        font3 = QFont()
        ...
        self.inc_type_gb.setGeometry(QRect(400, 130, 271, 81))
        ...
        self.inc_num_gb.setGeometry(QRect(400, 30, 271, 81))
        ...
        self.exposure_type_gb.setGeometry(QRect(700, 30, 271, 81))
        ...
        self.dirty_gear_gb.setGeometry(QRect(700, 130, 271, 81))
        ...
        self.expo_type_widget.setGeometry(QRect(1040, 40, 511, 731))
        ...
        self.what_burn_gb.setGeometry(QRect(20, 19, 330, 91))
        font5 = QFont()
        ...
        self.what_burn_cmb.setGeometry(QRect(20, 40, 291, 31))
        font6 = QFont()
        ...
        self.fire_cond_gb.setGeometry(QRect(20, 110, 330, 81))
        ...
        self.fire_cond_cmb.setGeometry(QRect(20, 30, 290, 31))
        ...
        self.smoke_inter_gb.setGeometry(QRect(20, 290, 330, 91))
        ...
        self.foam_cmb.setGeometry(QRect(20, 29, 211, 31))
        self.foam_cmb.setFont(font4)
        self.foam_cmb.setCursor(QCursor(Qt.ArrowCursor))
        self.foam_cmb.setEditable(False)
        self.washed_gear_gb = QGroupBox(self.expo_fire_page)
        self.washed_gear_gb.setObjectName(u"washed_gear_gb")
        self.washed_gear_gb.setGeometry(QRect(20, 400, 461, 281))
        self.washed_gear_gb.setFont(font3)
        self.washed_gear_gb.setAlignment(Qt.AlignCenter)
        self.washed_gear_gb.setFlat(False)
        self.washed_gear_gb.setCheckable(False)
        self.helment_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.helment_cleaned_chkbx.setObjectName(u"helment_cleaned_chkbx")
        self.helment_cleaned_chkbx.setGeometry(QRect(10, 30, 101, 31))
        self.helment_cleaned_chkbx.setFont(font2)
        self.helment_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.helment_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.helment_cleaned_chkbx.setChecked(False)
        self.helment_cleaned_chkbx.setTristate(False)
        self.hood_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.hood_cleaned_chkbx.setObjectName(u"hood_cleaned_chkbx")
        self.hood_cleaned_chkbx.setGeometry(QRect(10, 80, 101, 31))
        self.hood_cleaned_chkbx.setFont(font2)
        self.hood_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.hood_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.hood_cleaned_chkbx.setChecked(False)
        self.hood_cleaned_chkbx.setTristate(False)
        self.coat_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.coat_cleaned_chkbx.setObjectName(u"coat_cleaned_chkbx")
        self.coat_cleaned_chkbx.setGeometry(QRect(10, 130, 71, 31))
        self.coat_cleaned_chkbx.setFont(font2)
        self.coat_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.coat_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.coat_cleaned_chkbx.setChecked(False)
        self.coat_cleaned_chkbx.setTristate(False)
        self.pants_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.pants_cleaned_chkbx.setObjectName(u"pants_cleaned_chkbx")
        self.pants_cleaned_chkbx.setGeometry(QRect(160, 80, 101, 31))
        self.pants_cleaned_chkbx.setFont(font2)
        self.pants_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.pants_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.pants_cleaned_chkbx.setChecked(False)
        self.pants_cleaned_chkbx.setTristate(False)
        self.boots_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.boots_cleaned_chkbx.setObjectName(u"boots_cleaned_chkbx")
        self.boots_cleaned_chkbx.setGeometry(QRect(160, 180, 181, 31))
        self.boots_cleaned_chkbx.setFont(font2)
        self.boots_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.boots_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.boots_cleaned_chkbx.setChecked(False)
        self.boots_cleaned_chkbx.setTristate(False)
        self.gloves_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.gloves_cleaned_chkbx.setObjectName(u"gloves_cleaned_chkbx")
        self.gloves_cleaned_chkbx.setGeometry(QRect(10, 180, 101, 31))
        self.gloves_cleaned_chkbx.setFont(font2)
        self.gloves_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.gloves_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.gloves_cleaned_chkbx.setChecked(False)
        self.gloves_cleaned_chkbx.setTristate(False)
        self.scba_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.scba_cleaned_chkbx.setObjectName(u"scba_cleaned_chkbx")
        self.scba_cleaned_chkbx.setGeometry(QRect(10, 230, 101, 31))
        self.scba_cleaned_chkbx.setFont(font2)
        self.scba_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.scba_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.scba_cleaned_chkbx.setChecked(False)
        self.scba_cleaned_chkbx.setTristate(False)
        self.scba_face_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.scba_face_cleaned_chkbx.setObjectName(u"scba_face_cleaned_chkbx")
        self.scba_face_cleaned_chkbx.setGeometry(QRect(160, 230, 281, 31))
        self.scba_face_cleaned_chkbx.setFont(font2)
        self.scba_face_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.scba_face_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.scba_face_cleaned_chkbx.setChecked(False)
        self.scba_face_cleaned_chkbx.setTristate(False)
        self.helm_liner_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.helm_liner_cleaned_chkbx.setObjectName(u"helm_liner_cleaned_chkbx")
        self.helm_liner_cleaned_chkbx.setGeometry(QRect(160, 30, 291, 31))
        self.helm_liner_cleaned_chkbx.setFont(font2)
        self.helm_liner_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.helm_liner_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.helm_liner_cleaned_chkbx.setChecked(False)
        self.helm_liner_cleaned_chkbx.setTristate(False)
        self.wldlnd_cleaned_chkbx = QCheckBox(self.washed_gear_gb)
        self.wldlnd_cleaned_chkbx.setObjectName(u"wldlnd_cleaned_chkbx")
        self.wldlnd_cleaned_chkbx.setGeometry(QRect(160, 130, 191, 31))
        self.wldlnd_cleaned_chkbx.setFont(font2)
        self.wldlnd_cleaned_chkbx.setLayoutDirection(Qt.LeftToRight)
        self.wldlnd_cleaned_chkbx.setIconSize(QSize(16, 16))
        self.wldlnd_cleaned_chkbx.setChecked(False)
        self.wldlnd_cleaned_chkbx.setTristate(False)
        ...
        self.ems_expo_type_gb.setGeometry(QRect(20, 20, 271, 81))
        ...
        self.bio_chem_widget.setGeometry(QRect(20, 110, 271, 371))
        ...
        self.skin_infect_chkbx.setGeometry(QRect(10, 60, 161, 41))
        ...
        self.bio_airbrn_chkbx.setGeometry(QRect(10, 110, 111, 41))
        ...
        self.contagious_chkbx.setGeometry(QRect(10, 160, 251, 61))
        ...
        self.fld_water_chkbx.setGeometry(QRect(10, 230, 141, 31))
        ...
        self.bio_other_chkbx.setGeometry(QRect(10, 280, 81, 31))
        ...
        self.bio_other_edit.setGeometry(QRect(10, 330, 251, 22))
        ...
        self.chem_airbrn_chkbx.setGeometry(QRect(10, 20, 161, 41))
        ...
        self.skin_contact_chkbx.setGeometry(QRect(10, 90, 161, 41))
        ...
        self.tox_water_chkbx.setGeometry(QRect(10, 160, 161, 41))
        ...
        self.chem_other_chkbx.setGeometry(QRect(10, 230, 161, 41))
        ...
        self.chem_other_edit.setGeometry(QRect(10, 300, 251, 22))
        ...
        self.worn_equp_gb.setGeometry(QRect(20, 500, 421, 191))
        ...
        self.eye_prot_chkbx.setGeometry(QRect(230, 40, 191, 30))
        ...
        self.resp_prot_chkbx.setGeometry(QRect(10, 110, 281, 31))
        ...
        self.mask_chkbx.setGeometry(QRect(230, 80, 101, 21))
        ...
        self.fluid_resis_chkbx.setGeometry(QRect(10, 150, 291, 31))
        ...
        self.situation_sev_gb.setGeometry(QRect(20, 390, 231, 81))
        ...
        self.situation_sev_cmb.setGeometry(QRect(20, 30, 191, 31))
        font7 = QFont()
        font7.setPointSize(10)
        font7.setBold(True)
        self.situation_sev_cmb.setFont(font7)
        ...
        self.mats_search_gb.setGeometry(QRect(20, 10, 461, 351))
        ...
        self.mat_state_gb = QGroupBox(self.expo_haz_page)
        self.mat_state_gb.setObjectName(u"mat_state_gb")
        self.mat_state_gb.setGeometry(QRect(250, 390, 231, 81))
        self.mat_state_gb.setFont(font3)
        self.mat_state_gb.setAlignment(Qt.AlignCenter)
        self.mat_state_gb.setFlat(False)
        self.mat_state_gb.setCheckable(False)
        self.mat_state_cmb = QComboBox(self.mat_state_gb)
        self.mat_state_cmb.addItem("")
        self.mat_state_cmb.addItem("")
        self.mat_state_cmb.addItem("")
        self.mat_state_cmb.addItem("")
        self.mat_state_cmb.addItem("")
        ...
        self.mat_state_cmb.addItem("")
        self.mat_state_cmb.addItem("")
        self.mat_state_cmb.setObjectName(u"mat_state_cmb")
        self.mat_state_cmb.setGeometry(QRect(20, 30, 191, 31))
        self.mat_state_cmb.setFont(font7)
        self.mat_state_cmb.setCursor(QCursor(Qt.ArrowCursor))
        self.mat_stable_gb = QGroupBox(self.expo_haz_page)
        self.mat_stable_gb.setObjectName(u"mat_stable_gb")
        self.mat_stable_gb.setGeometry(QRect(20, 480, 211, 81))
        self.mat_stable_gb.setFont(font3)
        self.mat_stable_gb.setAlignment(Qt.AlignCenter)
        self.mat_stable_gb.setFlat(False)
        self.mat_stable_gb.setCheckable(False)
        self.mat_stable_radio_btn = QRadioButton(self.mat_stable_gb)
        self.mat_stable_radio_btn.setObjectName(u"mat_stable_radio_btn")
        self.mat_stable_radio_btn.setGeometry(QRect(30, 40, 71, 20))
        self.mat_not_stable_radio_btn = QRadioButton(self.mat_stable_gb)
        self.mat_not_stable_radio_btn.setObjectName(u"mat_not_stable_radio_btn")
        self.mat_not_stable_radio_btn.setGeometry(QRect(110, 40, 101, 20))
        self.gear_worn_gb = QGroupBox(self.expo_haz_page)
        self.gear_worn_gb.setObjectName(u"gear_worn_gb")
        self.gear_worn_gb.setGeometry(QRect(20, 570, 461, 81))
        self.gear_worn_gb.setFont(font3)
        self.gear_worn_gb.setAlignment(Qt.AlignCenter)
        self.gear_worn_gb.setFlat(False)
        self.gear_worn_gb.setCheckable(False)
        self.gear_worn_cmb = QComboBox(self.gear_worn_gb)
        self.gear_worn_cmb.addItem("")
        self.gear_worn_cmb.addItem("")
        self.gear_worn_cmb.addItem("")
        self.gear_worn_cmb.addItem("")
        self.gear_worn_cmb.addItem("")
        self.gear_worn_cmb.setObjectName(u"gear_worn_cmb")
        self.gear_worn_cmb.setGeometry(QRect(20, 30, 421, 31))
        font8 = QFont()
        font8.setPointSize(9)
        font8.setBold(True)
        self.gear_worn_cmb.setFont(font8)
        self.gear_worn_cmb.setCursor(QCursor(Qt.ArrowCursor))
        self.gear_worn_cmb.setMaxVisibleItems(5)
        self.gear_worn_cmb.setModelColumn(0)
        self.expo_type_widget.addWidget(self.expo_haz_page)
        self.expo_tech_page = QWidget()
        self.expo_tech_page.setObjectName(u"expo_tech_page")
        self.tech_rescue_type_gb = QGroupBox(self.expo_tech_page)
        self.tech_rescue_type_gb.setObjectName(u"tech_rescue_type_gb")
        self.tech_rescue_type_gb.setGeometry(QRect(20, 40, 330, 100))
        self.tech_rescue_type_gb.setFont(font5)
        self.tech_rescue_type_gb.setAlignment(Qt.AlignCenter)
        self.tech_rescue_type_gb.setFlat(False)
        self.tech_rescue_type_gb.setCheckable(False)
        self.tech_rescue_type_cmb = QComboBox(self.tech_rescue_type_gb)
        self.tech_rescue_type_cmb.addItem("")
        self.tech_rescue_type_cmb.addItem("")
        self.tech_rescue_type_cmb.addItem("")
        self.tech_rescue_type_cmb.addItem("")
        self.tech_rescue_type_cmb.addItem("")
        ...
        self.tech_rescue_type_cmb.addItem("")
        self.tech_rescue_type_cmb.addItem("")
        self.tech_rescue_type_cmb.setObjectName(u"tech_rescue_type_cmb")
        self.tech_rescue_type_cmb.setGeometry(QRect(20, 40, 290, 40))
        self.tech_rescue_type_cmb.setFont(font6)
        self.expo_type_widget.addWidget(self.expo_tech_page)
        ...
        self.expo_gear_gb.setGeometry(QRect(700, 230, 271, 280))
...
"Report", None))
        ...
        self.washed_gear_gb.setTitle(QCoreApplication.translate("Form", u"Washed Gear", None))
        self.helment_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Helmet", None))
        self.hood_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Hood", None))
        self.coat_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Coat", None))
        self.pants_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Pants", None))
        self.boots_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Station Gear", None))
        self.gloves_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Gloves", None))
        self.scba_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"SCBA", None))
        self.scba_face_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"SCBA Face Piece/Mask", None))
        self.helm_liner_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Helmet Linear/Ear Flaps", None))
        self.wldlnd_cleaned_chkbx.setText(QCoreApplication.translate("Form", u"Wildland Gear", None))
...
"COVID 19", None))
        ...
        self.mat_state_gb.setTitle(QCoreApplication.translate("Form", u"Material State", None))
        self.mat_state_cmb.setItemText(0, "")
        self.mat_state_cmb.setItemText(1, QCoreApplication.translate("Form", u"Combustable", None))
        self.mat_state_cmb.setItemText(2, QCoreApplication.translate("Form", u"Dust", None))
        self.mat_state_cmb.setItemText(3, QCoreApplication.translate("Form", u"Flood Water", None))
        self.mat_state_cmb.setItemText(4, QCoreApplication.translate("Form", u"Heavy Mist", None))
        self.mat_state_cmb.setItemText(5, QCoreApplication.translate("Form", u"Heavy Particulate", None))
        self.mat_state_cmb.setItemText(6, QCoreApplication.translate("Form", u"Liquid", None))
        self.mat_state_cmb.setItemText(7, QCoreApplication.translate("Form", u"Solid", None))
        self.mat_state_cmb.setItemText(8, QCoreApplication.translate("Form", u"Vapor/Gas", None))

        self.mat_state_cmb.setPlaceholderText("")
        self.mat_stable_gb.setTitle(QCoreApplication.translate("Form", u"Material Stability", None))
        self.mat_stable_radio_btn.setText(QCoreApplication.translate("Form", u"Stable", None))
        self.mat_not_stable_radio_btn.setText(QCoreApplication.translate("Form", u"Not Stable", None))
        self.gear_worn_gb.setTitle(QCoreApplication.translate("Form", u"Protective Gear Worn", None))
        self.gear_worn_cmb.setItemText(0, "")
        self.gear_worn_cmb.setItemText(1, QCoreApplication.translate("Form", u"Level A - Full skin, respiratory, and eye protection", None))
        self.gear_worn_cmb.setItemText(2, QCoreApplication.translate("Form", u"Level B - Full respiratory protection & lesser amount of skin protection", None))
        self.gear_worn_cmb.setItemText(3, QCoreApplication.translate("Form", u"Level C - Necessary respiratory protection for known airborne substances", None))
        self.gear_worn_cmb.setItemText(4, QCoreApplication.translate("Form", u"Level D - Work uniform (Minimal protection)", None))

        self.gear_worn_cmb.setPlaceholderText("")
        self.tech_rescue_type_gb.setTitle(QCoreApplication.translate("Form", u"Type of Rescue", None))
        self.tech_rescue_type_cmb.setItemText(0, "")
        self.tech_rescue_type_cmb.setItemText(1, QCoreApplication.translate("Form", u"Elevator", None))
        self.tech_rescue_type_cmb.setItemText(2, QCoreApplication.translate("Form", u"Rapid/Swift Water", None))
        self.tech_rescue_type_cmb.setItemText(3, QCoreApplication.translate("Form", u"Still Water", None))
        self.tech_rescue_type_cmb.setItemText(4, QCoreApplication.translate("Form", u"Confined Space", None))
        self.tech_rescue_type_cmb.setItemText(5, QCoreApplication.translate("Form", u"Trench", None))
        self.tech_rescue_type_cmb.setItemText(6, QCoreApplication.translate("Form", u"Technical Rescue", None))
        self.tech_rescue_type_cmb.setItemText(7, QCoreApplication.translate("Form", u"High Angle", None))
        self.tech_rescue_type_cmb.setItemText(8, QCoreApplication.translate("Form", u"Low Angle", None))
        self.tech_rescue_type_cmb.setItemText(9, QCoreApplication.translate("Form", u"Entrapment", None))
        self.tech_rescue_type_cmb.setItemText(10, QCoreApplication.translate("Form", u"Other", None))

        self.tech_rescue_type_cmb.setCurrentText("")
        self.tech_rescue_type_cmb.setPlaceholderText("")
